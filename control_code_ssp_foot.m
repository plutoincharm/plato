...
global A B Nx Nu pert MI L m  nx ny tx ty g r lam vars misc alp alpval indic kc lamall xdata lamx lamy val af
...
%%%% End of Backward Pass %%%%%
   ...
   % alp =alpval(:,frame) 
    ...
    xdata = x0;   
     alp(1) =alpval(4,frame);   
    alp(2) =alpval(8,frame);   
    alp(3) =alpval(9,frame);   
   for kc = 1:(Nt-1)
