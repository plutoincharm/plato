function qddot = fun_qddotsspfoot_typ2(x,u,dt)
%%%% SSP phase- 2   %%%%%%%%%%%%%%


global A B Nx Nu pert MI L m nx ny tx ty g  r lam  vars misc alp indic kc lamall xdata lamx lamy af
...
% lamx = lamt;
 %lamy = lamn;
disp('Original cost:heeeeeeeeeeeeeeeeeeeeeeeeereeeeeeeeeeeeeeeeeeeeeeeeeee')
end
